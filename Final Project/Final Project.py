...
def contact_page(userPin):
    ...
    refreshContacts = Button(contactPage, text="Refresh", bg="white", fg="blue", command=refresh_contacts).pack()
    ...
    addFrame = Frame(contactPage, width=500, height=500)
...
def login():
    ...
    topFrame = Frame(loginPage, width=300, height=30)
    topFrame.pack()
    ...
    pinLabel = Label(bottomFrame, text="Enter Pin:").pack()
...
def register():
    ...
    topFrame.pack()
    bottomFrame = Frame(registerPage, width=300, height=300)
    bottomFrame.pack(side=BOTTOM)
